...
namespace RepairSite.Controllers
{
    public class MechanicsController : Controller
    {
        ...
        {
            return View(db.Mechanic.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "MechanicID,FirstName,LastName,Phone,Email,Salary")] Mechanic mechanic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MechanicID,FirstName,LastName,Phone,Email,Salary")] Mechanic mechanic)
        {
            if (ModelState.IsValid)
            {
